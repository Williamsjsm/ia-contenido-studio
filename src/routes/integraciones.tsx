...
import { hasGeneratorConfigured } from "@/lib/generate-prompt.functions";
...
const aiServices: AIService[] = [
  { id: "chatgpt", name: "ChatGPT / Lovable Gateway", icon: MessageSquare, gradient: "from-[#10A37F] to-[#1FD0A3]", status: "disconnected", account: null, lastSync: null, category: "Lenguaje · Generador de Prompts" },
            ...
            s.id === "chatgpt"
              ? r.configured
                ? {
                    ...
                    status: "connected",
                    account: r.model
                      ? `${r.provider === "lovable" ? "Lovable Gateway" : "OpenAI directo"} · ${r.model}`
                      : "IA configurada",
                    lastSync: "Activo",
                  }
